...
extern int   optind; /* The actual index of the current option. */
...
for the current segment.Valid values are 1, for short options, 2, for long opt-
ions, and 3, for both short and long options.
*/
...
(The actual index of the option is stored in optind.)  If the option is
not valid in the array,     j_getopt() may err or return a value larger
than the final index of the array.     When further argument parsing is
prevented, j_getopt() returns a negative value.
